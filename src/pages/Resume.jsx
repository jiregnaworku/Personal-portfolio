      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold text-white mb-4">
            My <span className="text-blue-300">Resume</span>
          </h2>
          <div className="w-24 h-1 bg-blue-300 mx-auto rounded-full mb-8"></div>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            A comprehensive overview of my education, experience, and technical
            skills.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              <div className="flex items-center mb-6">
                <FaGraduationCap className="text-3xl text-blue-300 mr-4" />
              ...
              <div className="mb-6">
                ...
                <p className="text-blue-100">
                  Currently pursuing my degree with focus on web and mobile
                  development.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              <div className="flex items-center mb-6">
                <FaTools className="text-3xl text-blue-300 mr-4" />
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[
                      ...
                      <span
                        key={skill}
                        className="px-3 py-2 bg-white/20 text-white rounded-lg text-sm font-medium"
                      >
                        {skill}
                      </span>
                    ))}
          ...
          <div className="space-y-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              <div className="flex items-center mb-6">
                <FaBriefcase className="text-3xl text-blue-300 mr-4" />
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex items-center text-blue-100 text-sm mb-3">
                    <FaMapMarkerAlt className="mr-2" />
                    Addis Ababa, Ethiopia (2025/2/01 - 2025/5/15)
                  </div>
                  <p className="text-blue-100">
                    Working on House Rental Management System using MERN stack
                    and React Native.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-blue-100">
                    Building web and mobile applications including Online Coffee
                    Shop and Kids Learning App.
                  </p>
                </div>
              </div>
            </div>
